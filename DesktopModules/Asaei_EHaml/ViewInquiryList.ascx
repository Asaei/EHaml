<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewInquiryList.ascx.cs" Inherits="Asaei_EHaml.ViewInquiryList" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type: "GET",
            url: sf.getServiceRoot('Services') + "Inquiry/GetInquiryListForViewInquiryList",
