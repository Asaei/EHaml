<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="EHamlInquiryList.View" %>
            ...
            <div class="item-main">
                ...
                <div class="left-side">
                    ...
                    <div class="replay-button">
                        <a class="dnnSecondaryAction" href="javascript:void(0);" onclick="replyToInquiry(encodeURIComponent('#:ReplyUrl#'));">پاسخ</a>
                    </div>
                </div>
            </div>
		</td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type: "GET",
            url: sf.getServiceRoot('EHamlLibrary') + "InquiryList/GetInquiryListForViewInquiryList",
    ...
    function replyToInquiry(replyUrl) {
        window.location.href = decodeURIComponent(replyUrl);
