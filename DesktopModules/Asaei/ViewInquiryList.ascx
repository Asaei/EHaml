<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewInquiryList.ascx.cs" Inherits="Asaei.ViewInquiryList" %>
<%@ Register TagPrefix="dnn" Namespace="DotNetNuke.Web.Client.ClientResourceManagement" Assembly="DotNetNuke.Web.Client" %>

<dnn:dnncssinclude id="DnnCssInclude1" runat="server" filepath="~/DesktopModules/Asaei/Styles/kendo.common.min.css" />
<dnn:dnncssinclude id="DnnCssInclude3" runat="server" filepath="~/DesktopModules/Asaei/Styles/kendo.rtl.min.css" />

<script src="/Scripts/kendo.web.min.js"> </script>
<script src="/Scripts/xdate.js"> </script>
<script src="/Scripts/date.js"> </script>
<script src="/Scripts/mydnn.js"> </script>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type: "GET",
            url: sf.getServiceRoot('AsaeiViewInquiryList') + "Inquiry/GetInquiryListForViewInquiryList",
