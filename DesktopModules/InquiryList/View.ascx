<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="InquiryList.View" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type: "GET",
            url: sf.getServiceRoot('Services') + "InquiryList/GetInquiryListForViewInquiryList",
