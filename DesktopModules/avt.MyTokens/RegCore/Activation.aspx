<%@ Page Language="C#" AutoEventWireup="true" Inherits="avt.MyTokens.RegCore.WebClient.ActivationWnd" EnableViewState = "true" CodeBehind="Activation.aspx.cs" %>
...
<body id="Body" runat="server" style="background: #fff;">
