<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="UnlockTrial.aspx.cs" Inherits="avt.MyTokens.RegCore.WebClient.UnlockTrial" %>
        ...
        <div>
            ...
            <div style="margin: 80px 0px;">
                ...
                <div style = "margin:20px;" runat="server" id="pnlUnlockTrial">
                    ...
                    <asp:RegularExpressionValidator runat="server" ID="vldUnlockTrial_EmailFormat" ControlToValidate="tbTrialEmail" Text="Invalid email" Display="Dynamic" ValidationExpression="^[A-Za-z0-9_\+-]+(\.[A-Za-z0-9_\+-]+)*@[A-Za-z0-9-]+(\.[A-Za-z0-9-]+)*\.([A-Za-z]{2,4})$"></asp:RegularExpressionValidator>
                    <br />
